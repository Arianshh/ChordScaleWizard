...
chord_interval = {
    ...
    '9#5b13': [0, 4, 8, 10, 14, 20, 21],
    '7b9b13': [0, 4, 7, 10, 13, 20],
    '13b9b5': [0, 4, 6, 10, 13, 21],
    '7#5b9b13': [0, 4, 6, 8, 10, 20],
    '7#5#9b13': [0, 4, 8, 10, 15, 20],
    '13#11': [0, 4, 7, 11, 14, 17, 21],
    '7b5b9#11': [0, 4, 6, 10, 13, 18],
    '9#5#11': [0, 4, 8, 10, 14, 18],
    '7#5b9#11': [0, 4, 6, 8, 10, 18],
    '7b9#11b13': [0, 4, 7, 10, 13, 17, 20],
    '7#9b13': [0, 4, 7, 10, 15, 20],
    '13#9#11': [0, 4, 7, 10, 15, 17, 21],
    '7#5#9b9': [0, 4, 6, 8, 10, 13, 15],
    '7#5#9b9b13': [0, 4, 6, 8, 10, 15, 20]
}
